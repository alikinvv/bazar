...
$(document).click(function (event) {
  if (!$(event.target).closest('.top__menu-link').length && !$(event.target).closest('.menu .parent').length && !$(event.target).closest('.dropdown').length && !$(event.target).closest('.header__catalog').length) {
